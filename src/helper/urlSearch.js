const urlSearchMovie = {
  1: 'https://api.themoviedb.org/3/movie/latest?api_key=<<api_key>>&language=en-US',
  2: 'https://api.themoviedb.org/3/movie/popular?api_key=<<api_key>>&language=en-US&page=1',
  3: 'https://api.themoviedb.org/3/movie/top_rated?api_key=<<api_key>>&language=en-US&page=1'
}
